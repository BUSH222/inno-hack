...
## Заключение
Приложение не было закончено так как мы не дошли до конечного этапа, но хотя бы отображает существующие данные в качестве улучшения его можно доделать и сделать апишку.
